...
const ProgressCounter = ({progressCounter}) => {
    return (
        ...
        [background-size:auto,auto,cover] bg-[url("/assets/vector1.png"),url("/assets/vector_2.png"),linear-gradient(125.07deg,#632EE3_0%,#9F62F2_100%)]'>
            <h3 className='text-2xl text-white'>In Progress</h3>
            <h1 className='text-4xl font-bold text-white'>{progressCounter}</h1>
        </div>
    );
};
